...
def _circle_vertex_differentials(ri,rj,Ri,Rj,no_touch_mat):
    ...
    dhCCW_dRi,dhCW_dRi = da_dRi - db_dRi, da_dRi + db_dRi
    dhCCW_dRi = _replace_val(dhCCW_dRi,no_touch_mat[:,:,:,0],0)
    dhCW_dRi = _replace_val(dhCW_dRi, no_touch_mat[:,:,:,0], 0)
