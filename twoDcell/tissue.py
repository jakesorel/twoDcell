...
from twoDcell.active_force import ActiveForce
from twoDcell.force import Force
from twoDcell.mesh import Mesh
from twoDcell import utils
...
class Tissue:
    ...
    def initialize_mesh(self, x=None,run_options=None):
        ...
        self.mesh = Mesh(x, self.L, self.radius, run_options=run_options)
